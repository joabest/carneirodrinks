    ...
    <main className="min-h-screen pb-20 md:pb-0">
      <header className="sticky top-0 z-40 border-b border-white/5 bg-[#0a0605]/90 backdrop-blur-xl">
        <div className="container-site flex h-16 items-center justify-between gap-3">
          <a href="#" className="flex items-center" aria-label="Carneiro Drinks - início">
            <img src="https://raw.githubusercontent.com/joabest/carneirodrinks/test/public/carneiro-drinks-logo.svg" alt="Carneiro Drinks" className="h-14 w-auto object-contain drop-shadow-[0_0_12px_rgba(208,16,47,.24)]" />
          </a>
      ...
      <footer className="border-t border-white/5 bg-[#070404] py-10">
        <div className="container-site grid gap-8 md:grid-cols-3">
          <div><img src="https://raw.githubusercontent.com/joabest/carneirodrinks/test/public/carneiro-drinks-logo.svg" alt="Carneiro Drinks" className="h-28 w-auto object-contain" /><p className="mt-3 max-w-sm text-sm leading-6 text-white/45">Delivery de bebidas com compra rápida pelo WhatsApp ou pela 99.</p><p className="mt-3 text-[11px] font-bold uppercase tracking-wider text-white/30">Venda proibida para menores de 18 anos.</p></div>
